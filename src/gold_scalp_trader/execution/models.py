...
class ExecutionIntent:
    intent_id:str; action:ExecutionAction; symbol:str; direction:Direction; volume:float; price:float|None; sl:float|None; tp:float|None; state:IntentState; created_at:datetime; send_count:int=0; broker_ticket:int|None=None; reason:str=""

...
def _evidence(drill:str,*,observed:str="2026-09-25T11:59:00+00:00",valid_until:str|None=None):
    return {"schema_version":1,"mode":"DEMO","account_scope_sha256":"scope-a","symbol":"XAUUSDm","drill":drill,"result":"PASS","observed_at_utc":observed,"artifact_name":"evidence.txt","artifact_sha256":"a"*64,"valid_until_utc":valid_until,"note":"controlled connected drill"}
...
def test_operator_drill_evidence_requires_exact_scope_and_artifact_hash():
